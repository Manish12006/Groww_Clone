...
const SBI = () => {
  ...
  const [sellmodal, setsellmodal] = useState(false)
                                                                                        //CHANGE
  const [fluctuate, Setfluctuate] = useState(803.20)
...
useEffect(() => {
  ...
  return (
    <div>
      ...
      <img alt='zomato-logo' src={require('./stocks_media/SBI_logo.png')} className='zomato-logo'></img>
      <h2 className='zomato-heading-name'><b>SBI Bank</b></h2>
      ...
      <p className='aboutzomato'>About SBI Bank</p>
      ...
      <p className='parentorgvaluezomato'>SBI Bank</p>
      ...
      <p className='nsesymbolvaluezomato'>SBIBANK</p>
      <p className='homelinkzomato' onClick={() => navigate("/home")}> Home</p>
      <p className='cheronlinkzomato'> &gt;</p>
      {/*                                                                                                  CHANGE*/}
      <p className='zomatolinkzomato' onClick={() => navigate("/sbi")}> SBI Bank</p>
      <p className='latestpricezomato'>
        ₹{fluctuate.toFixed(2)}
      </p>
      <p className='monthlowvaluezomato'>800.40</p>
      <p className='monthhighvaluezomato'>809.15</p>
      <p className='Wlowvaluezomato'>543.20</p>
      <p className='Whighvaluezomato'>912.00</p>
      <p className='openvaluezomato'>800.95</p>
      <p className='prevvaluezomato'>803.00</p>
      <p className='volumevaluezomato'>1,17,88,665</p>
      <p className='TTVvaluezomato'>947 Cr</p>
      <p className='lowercircuitvaluezomato'>722.70</p>
      <p className='uppercircuitvaluezomato'>883.30</p>
        ...
        <div className='modal123'>
          ...
          <div className='whitescreenbg'>
            <div className='modal-content1'>
              ...
              <img src={require('./stocks_media/SBI_logo.png')} className='logopngmodalzomato' alt='zomatologomodal' />
              {/*                                                                                          CHANGE*/}
              <p className='companystockmodalzomato'>SBI</p>
              ...
              {/*                                                                                          CHANGE*/}
                  ...
                  <div className='paymentdetailszomato'>BOUGHT {quantity} x SBI at price {stockcontext.find(stock => stock.Instrument === Instrument).Avgvalue}</div>
...
{playvideo2 &&(
              ...
              {/*                                                                                          CHANGE*/}
                  ...
                  <div className='paymentdetailszomato'>SOLD {quantity} x SBI at price {stockcontext.find(stock => stock.Instrument === Instrument).Avgvalue}</div>
      ...
      <iframe
        src={`http://127.0.0.1:5000/sbichart?period=${period}`}
        width="600"
