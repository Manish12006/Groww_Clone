...
const Zomato = () => {
                                                                                        //CHANGE
  const [stockname, setstockname] = ("zomato")
  ...
  const [sellmodal, setsellmodal] = useState(false)
                                                                                        //CHANGE
  const [fluctuate, Setfluctuate] = useState(250.00)
...
useEffect(() => {
  ...
  return (
    <div>
      ...
      <img alt='zomato-logo' src={require('./stocks_media/Zomato_logo.png')} className='zomato-logo'></img>
      <h2 className='zomato-heading-name'><b>Zomato</b></h2>
      ...
      <p className='marketcapvaluezomato'>₹1,95,650Cr</p>
      <p className='PEratiovaluezomato'>554.13</p>
      <p className='PBratiovaluezomato'>9.58</p>
      <p className='industryvaluezomato'>189.03</p>
      ...
      <p className='roevaluezomato'>1.72%</p>
      <p className='epsvaluezomato'>80.40</p>
      <p className='dividendvaluezomato'>0.00%</p>
      <p className='bookvaluevaluezomato'>23.14</p>
      <p className='facevaluevaluezomato'>1</p>
      <p className='aboutzomato'>About Zomato Limited</p>
      <p className='aboutzomatovalue'>
      Zomato Limited operates as an Internet portal that helps in connecting the users, restaurant partners and delivery partners.<br />
        The Company also provides platform to restaurant partners to advertise themselves to the target audience in India and abroad <br />
        and supply of ingredients to restaurant partners. Its segments include India food ordering and delivery; Hyperpure supplies <br />
        (B2B business); Quick commerce business, and All other segments (residual). India food ordering and delivery is the online <br />
        platform through which the Company facilitates food ordering and delivery of the food items by connecting the end users,<br />
        restaurant partners and delivery personnel. Its Hyperpure supplies (B2B business) segment offers farm-to-fork supplies for <br />
        restaurants in India. Quick commerce business is a quick commerce online platform facilitating quick delivery of goods and<br />
        other essentials by connecting the end users, providing delivery services, and warehousing services.
      </p>
      <p className='parentorgzomato'>Parent Organisation</p>
      <p className='parentorgvaluezomato'>Zomato Limited</p>
      <p className='managingdirectorzomato'>Managing Director</p>
      <p className='managingdirectorvaluezomato'>Mr. Deepinder Goyal</p>
      <p className='nsesymbolzomato'>NSE Symbol</p>
      <p className='nsesymbolvaluezomato'>ZOMATO</p>
      
      <p className='homelinkzomato' onClick={() => navigate("/home")}> Home</p>
      <p className='cheronlinkzomato'> &gt;</p>
      {/*                                                                                                  CHANGE*/}
      <p className='zomatolinkzomato' onClick={() => navigate("/zomato")}> Zomato Limited</p>
      <p className='latestpricezomato'>
        ₹{fluctuate.toFixed(2)}
      </p>
      <p className='monthlowvaluezomato'>216.95</p>
      <p className='monthhighvaluezomato'>223.97</p>
      <p className='Wlowvaluezomato'>79.30</p>
      <p className='Whighvaluezomato'>232.00</p>
      <p className='openvaluezomato'>221.95</p>
      <p className='prevvaluezomato'>221.00</p>
      <p className='volumevaluezomato'>2,61,24,437</p>
      <p className='TTVvaluezomato'>573 Cr</p>
      <p className='lowercircuitvaluezomato'>263.17</p>
      <p className='uppercircuitvaluezomato'>175.44</p>
        ...
        <div className='modal123'>
          ...
          <div className='whitescreenbg'>
            <div className='modal-content1'>
              ...
              <img src={require('./stocks_media/Zomato_logo.png')} className='logopngmodalzomato' alt='zomatologomodal' />
              {/*                                                                                          CHANGE*/}
              <p className='companystockmodalzomato'>ZOMATO</p>
              ...
              {/*                                                                                          CHANGE*/}
                  ...
                  <div className='paymentdetailszomato'>BOUGHT {quantity} x Zomato at price {stockcontext.find(stock => stock.Instrument === Instrument).Avgvalue}</div>
...
{playvideo2 &&(
              ...
              {/*                                                                                          CHANGE*/}
                  ...
                  <div className='paymentdetailszomato'>SOLD {quantity} x ZOMATO at price {stockcontext.find(stock => stock.Instrument === Instrument).Avgvalue}</div>
      ...
      <iframe
        src={`http://127.0.0.1:5000/zomatochart?period=${period}`}
        width="600"
